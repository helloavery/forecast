...
public interface Constants {
    ...
    String DAO_USER_NOT_CREATED = "DAO; User not created";
    ...
    String USER_INVALID_LAST_NAME = "Invalid last name";
    ...
    /***MongoDB Collections**/
    String EMAIL_TOKEN_MONGO_COLLECTION = "emailToken";
    String ACCOUNT_STATUS_MONGO_COLLECTION = "accountStatus";
    String PRODUCT_DEMAND_MONGO_COLLECTION  = "productDemand";
    String PRODUCT_FORECAST_MONGO_COLLECTION = "productForecast";
    String AUDIT_TRAIL_MONGO_COLLECTION = "auditTrail";
    String REVISION_HISTORY_MONGO_COLLECTION = "revisionHistory";
    String USERS_MONGO_COLLECTION = "users";
    String USER_CREDS_MONGO_COLLECTION = "userCreds";
    String USER_ROLES_MONGO_COLLECTION = "userRooles";
